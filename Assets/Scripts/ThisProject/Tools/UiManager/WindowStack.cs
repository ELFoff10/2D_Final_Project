...
public class WindowStack
{
    ...
    {
        Debug.Log($"Prepare stack with first window '{first.Name}'");
        Clear();
        Add(first);
    }
    ...
    public void Add(Window window)
    {
        ...
        Debug.Log($"Added window: '{windowName}' with priority {window.Priority}");
    ...
    public void Remove(Window window)
    {
        ...
        {
            string windowName = window.Name;
            Debug.Log($"DestroyEnemy window '{windowName}'");
